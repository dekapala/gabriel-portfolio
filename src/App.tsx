...
const certifications: Certification[] = [
  {
    ...
    year: '2024',
    description:
      'Certificación enfocada en fundamentos de ciberseguridad, análisis de amenazas y respuesta a incidentes. Cubre conceptos esenciales para roles de analista SOC junior.',
  ...
  },
  {
    ...
    year: '2023',
    description:
      'Fundamentos de ciberseguridad con enfoque en conceptos de seguridad de red, firewalls, VPNs y políticas de seguridad. Introducción a la suite de productos Fortinet.',
  ...
  },
  {
    ...
    year: '2023',
    description:
      'Formación en servicios AWS fundamentales: EC2, S3, VPC, IAM. Diseño de arquitecturas cloud seguras y escalables. Implementación de buenas prácticas de seguridad en la nube.',
  ...
  },
  {
    ...
    year: '2021-2022',
    description:
      'Programa universitario intensivo en pentesting y seguridad ofensiva. Incluye técnicas de reconocimiento, explotación de vulnerabilidades, post-explotación y reportes técnicos.',
    skills: [
      'Penetration Testing',
  ...
  },
  {
    ...
    year: '2020-2021',
    description:
      'Certificación fundamental en networking: routing, switching, IPv4/IPv6, VLANs, protocolos de enrutamiento (OSPF, EIGRP), seguridad básica de red y troubleshooting.',
...
const projects = [
  {
    ...
    description:
      'Portfolio interactivo desarrollado 100% con IA (React, TypeScript, Vite, Tailwind). Incluye chatbot inteligente, diseño responsive y modo claro/oscuro.',
  ...
  },
  {
    ...
    description:
      'Herramienta interna de gestión de reportería para análisis ágil del sector. Automatiza análisis diarios y generación de informes. Desarrollado completamente con IA.',
  ...
  },
  {
    ...
    description:
      'Laboratorio de monitoreo y detección de amenazas con Suricata IDS usando Docker. Tuning de reglas para escenarios de port-scan/ARP.',
  ...
  },
  {
    ...
    description:
      'Sistema de detección de intrusiones (IDS) construido en Python usando Scapy. Captura y analiza tráfico LAN para detectar comportamientos sospechosos como port scans y ARP spoofing.',
  ...
  },
  {
    title: 'Port Scanner',
    description:
      'Escáner de puertos básico en Python para prácticas de ciberseguridad. Reconocimiento de red y auditorías de seguridad.',
  ...
  },
  {
    ...
    description:
      'Infraestructura local automatizada para prácticas de ciberseguridad con Docker y aplicaciones vulnerables (DVWA).',
...
const App = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    {
      role: 'assistant',
      text: '¡Hola! Soy tu asistente inteligente creado con IA. Pregúntame sobre la experiencia de Gabriel, sus proyectos con IA, certificaciones o su enfoque en automatización con Inteligencia Artificial.',
    },
  ]);
  ...
  const handleSendMessage = () => {
    ...
    if (msg.includes('ia') || msg.includes('inteligencia artificial') || msg.includes('ai') || msg.includes('chatgpt') || msg.includes('claude')) {
      response =
        '¡Exacto! Gabriel tiene un FOCO ACTUAL en IA para implementar mejoras en sectores operativos. Todos sus proyectos están desarrollados con IA: este portfolio completo con Claude AI, RepoAnalisis2 para reportería automatizada, y todos sus labs de ciberseguridad. Domina Prompt Engineering avanzado.';
    } else if (msg.includes('portfolio') || msg.includes('este sitio') || msg.includes('web')) {
      response =
        'Este portfolio fue creado 100% con Inteligencia Artificial usando Claude AI. Stack: React + TypeScript + Vite + Tailwind. Todo desarrollado mediante Prompt Engineering avanzado, desde el diseño hasta el chatbot que estás usando ahora. Código disponible en GitHub.';
    } else if (msg.includes('repoanalisis') || msg.includes('reportería') || msg.includes('herramienta')) {
      response =
        'RepoAnalisis2 es una herramienta interna de gestión de reportería que Gabriel está implementando en su sector. Permite análisis más ágiles de datos diarios y generación automática de informes. Completamente desarrollado con IA para optimizar procesos operativos.';
    } else if (msg.includes('experiencia') || msg.includes('experience') || msg.includes('trabajo')) {
      response =
        'Gabriel tiene 11 años en Telecom Argentina con progresión clara: Soporte Residencial (2014-2015), Corporativo (2015-2016), Network Analyst (2016-actualidad). Actualmente enfocado en implementar IA en operaciones y mejorar procesos con automatización inteligente.';
    } else if (msg.includes('proyecto') || msg.includes('project') || msg.includes('github')) {
      response =
        'Proyectos: Portfolio con IA (este sitio), RepoAnalisis2 (reportería automatizada), SOC Lab (Suricata IDS), Network Intrusion Detector, Port Scanner, CyberLab-Infra. TODOS desarrollados con IA. Disponibles en github.com/dekapala con documentación completa.';
    } else if (msg.includes('certificación') || msg.includes('cert') || msg.includes('curso')) {
      response =
        'Certificaciones: Junior Cybersecurity Analyst (Cisco 2024), Fortinet Fundamentals (2023), AWS Cloud Computing (2023), Experto Hacking Ético UTN (2021-22), CCNA v7 (2020-21). Click en cada una para ver skills adquiridos.';
    } else if (msg.includes('skill') || msg.includes('habilidad') || msg.includes('tecnología')) {
      response =
        'Blue Team: Suricata IDS, pcap/tcpdump, Wireshark, SIEM. Infra: DOCSIS, SNMP, Grafana. Dev: Python, React, TypeScript. AI Tools: ChatGPT, Claude, Gemini, Prompt Engineering. Foco actual: implementar IA en sectores para automatización y mejora de procesos.';
    } else if (msg.includes('soc') || msg.includes('blue team') || msg.includes('security')) {
      response =
        'Gabriel busca roles SOC Analyst (L1-L2) o posiciones enfocadas en implementación de IA para ciberseguridad. Combina 11 años de operaciones de red con labs prácticos de IDS/IPS y desarrollo con IA.';
    } else if (msg.includes('inglés') || msg.includes('ingles') || msg.includes('english') || msg.includes('idioma')) {
      response =
        'Inglés: B2 profesional (CEFR) - lectura, escritura y comprensión técnica avanzada. Puede trabajar con documentación técnica en inglés y comunicarse en entornos profesionales internacionales.';
    } else if (msg.includes('foco') || msg.includes('objetivo') || msg.includes('meta')) {
      response =
        'Foco actual: Implementar IA en sectores operativos para automatización y mejora de procesos. Combina experiencia en redes con desarrollo asistido por IA. Objetivo: roles donde pueda aplicar IA en ciberseguridad y operaciones (SOC + IA, Automation Engineer, DevSecOps con IA).';
    } else if (msg.includes('cv') || msg.includes('resume') || msg.includes('descargar')) {
      response =
        'Podés descargar el CV optimizado para ATS en español o inglés. Incluye keywords de Blue Team, métricas y proyectos con IA. PDFs profesionales listos para recruiters.';
    } else if (msg.includes('contacto') || msg.includes('contact') || msg.includes('email') || msg.includes('linkedin')) {
      response =
        'Email: gabrielleandro.p@outlook.com | Tel: +54 11 3097-6948 | LinkedIn: linkedin.com/in/gabrielpalazzini | GitHub: github.com/dekapala | Disponibilidad: Inmediata (híbrido/remoto).';
    } else if (msg.includes('hola') || msg.includes('hello') || msg.includes('hi')) {
      response =
        '¡Hola! 👋 Podés preguntarme sobre: experiencia (11 años), proyectos con IA (portfolio, RepoAnalisis2, labs), certificaciones, foco en implementación de IA en sectores, o cómo contactar a Gabriel.';
    } else {
      response =
        'Podés preguntarme sobre: experiencia laboral, proyectos desarrollados con IA (este portfolio, RepoAnalisis2, labs de ciberseguridad), certificaciones, foco actual en IA para sectores, skills técnicos, o contacto. ¿Qué te interesa?';
    }
    ...
    <div
      className={`min-h-screen transition-colors ${
        darkMode
          ...
          : 'bg-gradient-to-br from-gray-50 via-white to-gray-50 text-neutral-900'
      }`}
    >
      <header
        className={`sticky top-0 z-50 backdrop-blur-xl transition-colors ${
          darkMode ? 'bg-neutral-900/60 border-b border-neutral-800' : 'bg-white/80 border-b border-neutral-200'
        }`}
      >
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <a
                href="https://github.com/dekapala"
                target="_blank"
                rel="noopener noreferrer"
                className={`hover:text-cyan-400 transition ${darkMode ? 'text-neutral-400' : 'text-neutral-600'}`}
              >
                <Github className="w-5 h-5" />
              </a>
              <a
                href="https://linkedin.com/in/gabrielpalazzini"
                target="_blank"
                rel="noopener noreferrer"
                className={`hover:text-cyan-400 transition ${darkMode ? 'text-neutral-400' : 'text-neutral-600'}`}
              >
              ...
              <a
                href="mailto:gabrielleandro.p@outlook.com"
                className={`hover:text-cyan-400 transition ${darkMode ? 'text-neutral-400' : 'text-neutral-600'}`}
              >
              ...
              <button
                ...
                className={`p-2 rounded-lg transition ${
                  darkMode ? 'bg-neutral-800 hover:bg-neutral-700 text-yellow-400' : 'bg-neutral-100 hover:bg-neutral-200 text-neutral-700'
                }`}
              >
      ...
      <div className="max-w-6xl mx-auto px-6 py-8 space-y-6">
        <section
          className={`rounded-2xl p-8 border transition-all ${
            darkMode
              ? 'bg-gradient-to-br from-neutral-900 to-neutral-950 border-neutral-800 shadow-2xl shadow-cyan-500/5'
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              ...
              <p className={`text-sm leading-relaxed mb-4 ${darkMode ? 'text-neutral-300' : 'text-neutral-700'}`}>
                <span className="font-semibold">11+ años en redes críticas DOCSIS/HFC</span> (Telecom Argentina).
                Formación defensiva con <span className="text-cyan-400 font-semibold">Suricata IDS</span>, análisis de
                tráfico (Wireshark/tcpdump/pcap), <span className="text-cyan-400 font-semibold">triaje y respuesta inicial</span> en laboratorio (Docker/Kubernetes),{' '}
                <span className="text-cyan-400 font-semibold">SIEM (Wazuh/Splunk – lab)</span> y{' '}
                <span className="text-cyan-400 font-semibold">MITRE ATT&amp;CK</span>.{' '}
                <span className="font-semibold">Prompt Engineering + Python</span> para acelerar investigación y
                automatización. <span className="font-semibold">Objetivo: SOC Analyst (L1–L2)</span> con foco en
                detección y tuning de reglas.
              </p>
              ...
              <div
                className={`rounded-xl p-5 border ${
                  darkMode
                    ? 'bg-gradient-to-br from-purple-950/20 to-cyan-950/20 border-purple-900/30'
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-base mb-2 flex items-center gap-2">
                      ...
                      <span
                        className={`text-xs px-2 py-0.5 rounded ${
                          darkMode ? 'bg-purple-500/20 text-purple-300' : 'bg-purple-200 text-purple-700'
                        }`}
                      >
                        Foco actual
                      </span>
                    ...
                    <p className={`text-sm mb-3 ${darkMode ? 'text-neutral-300' : 'text-neutral-700'}`}>
                      Todos mis proyectos desarrollados con{' '}
                      <span className="font-semibold text-cyan-400">Prompt Engineering avanzado</span> (ChatGPT, Claude,
                      Gemini): este portfolio completo, RepoAnalisis2 (herramienta interna de reportería), y labs de
                      ciberseguridad. <span className="font-semibold">Objetivo: implementar IA en sectores operativos</span> para
                      automatización y mejora de procesos.
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <span
                        className={`text-xs px-2 py-1 rounded border ${
                          darkMode ? 'bg-purple-900/30 border-purple-700/50 text-purple-300' : 'bg-purple-100 border-purple-300 text-purple-700'
                        }`}
                      >
                        ChatGPT
                      </span>
                      ...
                      <span
                        className={`text-xs px-2 py-1 rounded border ${
                          darkMode ? 'bg-cyan-900/30 border-cyan-700/50 text-cyan-300' : 'bg-cyan-100 border-cyan-300 text-cyan-700'
                        }`}
                      >
                        Prompt Engineering
                      </span>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className={`text-xs ${darkMode ? 'text-neutral-300' : 'text-neutral-700'}`}>
                  <span className="font-semibold">SOC Analyst (Entry/Mid)</span> con foco en detección, triaje y
                  respuesta. Interés especial en roles que combinen ciberseguridad con implementación de IA:
                  automatización de análisis, SIEM con IA, o desarrollo de herramientas inteligentes para equipos de
                  seguridad.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            <span
              className={`px-3 py-1 rounded text-xs font-semibold ${
                darkMode ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/30' : 'bg-emerald-500/20 text-emerald-700 border border-emerald-500/30'
              }`}
            >
            ...
            <span
              className={`px-3 py-1 rounded text-xs font-semibold ${
                darkMode ? 'bg-blue-500/10 text-blue-400 border border-blue-500/30' : 'bg-blue-500/20 text-blue-700 border border-blue-500/30'
              }`}
            >
              HÍBRIDO / REMOTO
            </span>
            <span
              className={`px-3 py-1 rounded text-xs font-semibold ${
                darkMode ? 'bg-purple-500/10 text-purple-400 border border-purple-500/30' : 'bg-purple-500/20 text-purple-700 border border-purple-500/30'
              }`}
            >
            ...
            <span
              className={`px-3 py-1 rounded text-xs font-semibold ${
                darkMode ? 'bg-cyan-500/10 text-cyan-400 border border-cyan-500/30' : 'bg-cyan-500/20 text-cyan-700 border border-cyan-500/30'
              }`}
            >
        ...
        <section
          className={`rounded-2xl p-6 border transition-all hover:shadow-lg ${
            darkMode ? 'bg-neutral-950/50 border-neutral-800 hover:shadow-cyan-500/10' : 'bg-white border-neutral-200 hover:shadow-xl'
          }`}
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <span
              className={`ml-auto text-xs px-2 py-1 rounded border ${
                darkMode ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/30' : 'bg-emerald-500/20 text-emerald-700 border border-emerald-500/30'
              }`}
            >
              Optimizado ATS
            </span>
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            <a
              ...
              className={`group flex flex-col gap-2 p-4 rounded-lg border transition-all hover:scale-105 ${
                darkMode
                  ? 'bg-neutral-900/50 border-neutral-700 hover:border-cyan-500/50 hover:shadow-lg hover:shadow-cyan-500/20'
                  : 'bg-neutral-50 border-neutral-200 hover:border-cyan-500 hover:shadow-md'
              }`}
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex flex-col">
                    <span className={`font-semibold text-sm ${darkMode ? 'text-neutral-200' : 'text-neutral-800'}`}>Español</span>
                    <span className={`text-xs ${darkMode ? 'text-neutral-500' : 'text-neutral-500'}`}>Keywords ATS incluidos</span>
                  </div>
                </div>
            ...
            <a
              ...
              className={`group flex flex-col gap-2 p-4 rounded-lg border transition-all hover:scale-105 ${
                darkMode
                  ? 'bg-neutral-900/50 border-neutral-700 hover:border-blue-500/50 hover:shadow-lg hover:shadow-blue-500/20'
                  : 'bg-neutral-50 border-neutral-200 hover:border-blue-500 hover:shadow-md'
              }`}
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex flex-col">
                    <span className={`font-semibold text-sm ${darkMode ? 'text-neutral-200' : 'text-neutral-800'}`}>English</span>
                    <span className={`text-xs ${darkMode ? 'text-neutral-500' : 'text-neutral-500'}`}>ATS Keywords included</span>
                  </div>
                </div>
        ...
        <section className={`rounded-2xl border transition-all ${darkMode ? 'bg-neutral-950/50 border-neutral-800 hover:border-cyan-500/30' : 'bg-white border-neutral-200'}`}>
          <button
            ...
            className={`w-full flex items-center justify-between p-6 text-left transition rounded-t-2xl ${
              ...
              {projects.map((project, index) => (
                <a
                  ...
                  className={`block p-4 rounded-lg border transition-all hover:scale-[1.02] ${
                    darkMode
                      ? 'bg-neutral-900/50 border-neutral-800 hover:border-cyan-500/50 hover:shadow-lg hover:shadow-cyan-500/20'
                      : 'bg-neutral-50 border-neutral-200 hover:border-cyan-500 hover:shadow-md'
                  }`}
                >
                  ...
                  <p className={`text-sm mb-2 ${darkMode ? 'text-neutral-300' : 'text-neutral-700'}`}>{project.description}</p>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tech.map((tech, idx) => (
                      <span
                        key={idx}
                        className={`text-xs px-2 py-1 rounded border ${
                          darkMode ? 'bg-neutral-800 border-cyan-500/30 text-cyan-400' : 'bg-cyan-50 border-cyan-200 text-cyan-700'
                        }`}
                      >
                        {tech}
                      </span>
              ...
              <div className="grid lg:grid-cols-3 gap-4 mb-6">
                <div className={`lg:col-span-2 space-y-4`}>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {[
                        ...
                        <span
                          key={skill}
                          className={`text-xs px-2 py-1 rounded border ${
                            darkMode ? 'bg-neutral-900 border-purple-500/30 text-purple-400' : 'bg-purple-50 border-purple-200 text-purple-700'
                          }`}
                        >
                          {skill}
                        </span>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {[
                        ...
                        <span
                          key={skill}
                          className={`text-xs px-2 py-1 rounded border ${
                            darkMode ? 'bg-neutral-900 border-red-500/30 text-red-400' : 'bg-red-50 border-red-200 text-red-700'
                          }`}
                        >
                          {skill}
                        </span>
                  ...
                  <div className={`p-4 rounded-lg border ${darkMode ? 'bg-blue-950/10 border-blue-900/30' : 'bg-blue-50 border-blue-200'}`}>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {['DOCSIS/HFC', 'SNMP', 'ServAssure NXT', 'Grafana', 'Nagios/Icinga', 'TCP/IP', 'VLANs', 'DNS/DHCP', 'RX/TX/MER'].map(
                        (skill) => (
                          <span
                            key={skill}
                            className={`text-xs px-2 py-1 rounded border ${
                              darkMode ? 'bg-neutral-900 border-blue-500/30 text-blue-400' : 'bg-blue-50 border-blue-200 text-blue-700'
                            }`}
                          >
                            {skill}
                          </span>
                  ...
                  <div className={`p-4 rounded-lg border ${darkMode ? 'bg-emerald-950/10 border-emerald-900/30' : 'bg-emerald-50 border-emerald-200'}`}>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {['Python', 'Parsing/Logs', 'Bash', 'Git', 'Docker', 'Kubernetes', 'IaC', 'Ansible', 'React', 'TypeScript', 'HTML/CSS'].map(
                        (skill) => (
                          <span
                            key={skill}
                            className={`text-xs px-2 py-1 rounded border ${
                              darkMode ? 'bg-neutral-900 border-emerald-500/30 text-emerald-400' : 'bg-emerald-50 border-emerald-200 text-emerald-700'
                            }`}
                          >
                            {skill}
                          </span>
                  ...
                  <div className={`p-4 rounded-lg border ${darkMode ? 'bg-cyan-950/10 border-cyan-900/30' : 'bg-cyan-50 border-cyan-200'}`}>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {['Nmap', 'Nessus', 'Metasploit', 'Burp Suite', 'OWASP ZAP', 'AWS (EC2/S3/VPC)', 'EDR (lab)', 'Tuning Suricata'].map(
                        (skill) => (
                          <span
                            key={skill}
                            className={`text-xs px-2 py-1 rounded border ${
                              darkMode ? 'bg-neutral-900 border-cyan-500/30 text-cyan-400' : 'bg-cyan-50 border-cyan-200 text-cyan-700'
                            }`}
                          >
                            {skill}
                          </span>
                ...
                <div
                  className={`rounded-xl p-5 border h-fit sticky top-24 ${
                    darkMode ? 'bg-gradient-to-br from-cyan-950/30 to-purple-950/30 border-cyan-900/50' : 'bg-gradient-to-br from-cyan-50 to-purple-50 border-cyan-200'
                  }`}
                >
                  ...
                  <p className={`text-xs mb-3 ${darkMode ? 'text-neutral-300' : 'text-neutral-700'}`}>¿Por qué esta combinación funciona?</p>
                ...
                >
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <p className={`text-sm ${darkMode ? 'text-cyan-400' : 'text-cyan-600'}`}>{cert.issuer}</p>
                    </div>
                    <span className={`text-xs px-2 py-1 rounded ${darkMode ? 'bg-neutral-800 text-neutral-400' : 'bg-neutral-200 text-neutral-600'}`}>
                      {cert.year}
                    </span>
                  </div>
                  <p className={`text-xs mt-2 ${darkMode ? 'text-neutral-400' : 'text-neutral-600'}`}>Click para ver skills adquiridos →</p>
                </div>
              ))}
            </div>
          )}
          ...
          >
            <div className={`p-6 border-b ${darkMode ? 'border-neutral-800' : 'border-neutral-200'}`}>
              <div className="flex items-start justify-between">
                ...
                <button onClick={() => setSelectedCert(null)} className={`p-2 rounded-lg transition ${darkMode ? 'hover:bg-neutral-800' : 'hover:bg-neutral-100'}`}>
                  <X className="w-5 h-5" />
                </button>
              </div>
            </div>
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <p className={`text-sm ${darkMode ? 'text-neutral-300' : 'text-neutral-700'}`}>{selectedCert.description}</p>
              </div>
              ...
              {selectedCert.link && (
                <a href={selectedCert.link} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm text-cyan-400 hover:underline">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className={`flex-1 px-3 py-2 rounded-lg text-sm border ${
                    darkMode ? 'bg-neutral-800 border-neutral-700 text-neutral-200 placeholder-neutral-500' : 'bg-white border-neutral-300 text-neutral-900 placeholder-neutral-500'
                  }`}
                />
                <button onClick={handleSendMessage} className="px-4 py-2 bg-cyan-500 hover:bg-cyan-600 text-white rounded-lg text-sm font-medium transition">
                  Enviar
                </button>
              </div>
            </div>
