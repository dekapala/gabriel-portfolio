      ...
      <div className="max-w-6xl mx-auto px-6 py-8 space-y-6">
        ...
        <section className={`rounded-2xl p-6 border transition-all hover:shadow-lg ${darkMode ? 'bg-neutral-950/50 border-neutral-800 hover:shadow-cyan-500/10' : 'bg-white border-neutral-200 hover:shadow-xl'}`}>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className={`ml-auto text-xs px-2 py-1 rounded border ${darkMode ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/30' : 'bg-emerald-500/20 text-emerald-700 border-emerald-500/30'}`}>
              Optimizado ATS
            </span>
          </div>
